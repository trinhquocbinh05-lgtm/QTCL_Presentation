...
function App() {
  ...
  const totalSlides = 17; // Update this as we add more slides
  ...
  return (
    <div className="presentation-container">
      <AnimatePresence mode="wait">
        ...
        {currentSlide === 6 && <Slide6 key="slide6" />}
        {currentSlide === 7 && <Slide7 key="slide7" />}
        {currentSlide === 8 && <Slide8 key="slide8" />}
        {currentSlide === 9 && <Slide9 key="slide9" />}
        {currentSlide === 10 && <Slide10 key="slide10" />}
        {currentSlide === 11 && <Slide11 key="slide11" />}
        {currentSlide === 12 && <Slide12 key="slide12" />}
        {currentSlide === 13 && <Slide13 key="slide13" />}
        {currentSlide === 14 && <Slide14 key="slide14" />}
        {currentSlide === 15 && <Slide15 key="slide15" />}
        {currentSlide === 16 && <Slide16 key="slide16" />}
        {currentSlide === 17 && <Slide17 key="slide17" />}
      </AnimatePresence>
